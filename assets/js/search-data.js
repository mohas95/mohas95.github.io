...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "datasets-project-1",
          title: 'project 1',
          description: "with background image",
          section: "Datasets",handler: () => {
              window.location.href = "/datasets/1_project/";
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "robotfleet-project-1",
          title: 'project 1',
          description: "with background image",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/1_project/";
            },},{id: "robotfleet-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/2_project/";
            },},{id: "robotfleet-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/3_project/";
            },},{id: "robotfleet-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/4_project/";
            },},{id: "robotfleet-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/5_project/";
            },},{id: "robotfleet-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/6_project/";
            },},{id: "robotfleet-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/7_project/";
            },},{id: "robotfleet-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/8_project/";
            },},{id: "robotfleet-project-9",
          title: 'project 9',
          description: "another project with an image 🎉",
          section: "Robotfleet",handler: () => {
              window.location.href = "/robotfleet/9_project/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
